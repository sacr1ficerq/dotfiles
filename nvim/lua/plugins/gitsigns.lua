        ...
        config = function()
            require('gitsigns').setup {
                ...
                on_attach = function(bufnr)
                    ...
                    vim.keymap.set('v', 
                        '<leader>hs', function() gs.stage_hunk 
                            {vim.fn.line('.'), vim.fn.line('v')} end, { buffer = bufnr, desc = 'Stage Hunk' })
                    vim.keymap.set('v', 
                    '<leader>hr', function() gs.reset_hunk 
                    ...
                    vim.keymap.set('n',
                        '<leader>hb', function() gs.blame_line{full=true} end, { buffer = bufnr, desc = 'Blame Line' })
                    vim.keymap.set('n',
                        '<leader>tb', gs.toggle_current_line_blame, { buffer = bufnr, desc = 'Toggle Blame Line' })
                    vim.keymap.set('n',
                        '<leader>hd', gs.diffthis, { buffer = bufnr, desc = 'Diff This' })
                    vim.keymap.set('n',
                        '<leader>hD', function() gs.diffthis('~') end, { buffer = bufnr, desc = 'Diff This ~' })
                    vim.keymap.set('n',
                        '<leader>td', gs.toggle_deleted, { buffer = bufnr, desc = 'Toggle Deleted' })
